  ...
  const softwareCourses = [
    {
      ...
      description:
        "Become a job-ready Full Stack Development professional in 20 weeks. Join the largest tech community in India. Pay only after you get a job above 3.6 LPA",
      duration: "4 Months",
    ...
    <>
      <div className="pt-[1.3rem] sm:pt-[2rem] pb-[4rem] flex flex-col items-center justify-center dark:bg-dark">
        <h1 className="mb-4 text-3xl sm:text-5xl font-semibold text-center text-primary ">
          Featured <span className="text-r dark:text-r">Courses</span>
        </h1>
        <Tabs
          defaultValue="sc"
          className="w-[270px] sm:w-[400px] flex flex-col items-center justify-center"
        >
          <TabsList className="mb-5 hidden sm:grid w-auto sm:w-full grid-cols-2 border-re">
            <TabsTrigger value="sc">Software Courses</TabsTrigger>
            <TabsTrigger value="bc">Business Courses</TabsTrigger>
          </TabsList>
          <TabsList className="mb-5 sm:hidden h-11 grid grid-cols-2 border-re">
            ...
            <div className="w-screen">
              <div className="grid grid-cols-2 items-center border  ">
                {softwareCourses.map((course, index) => (
                  <Card
                    key={index}
                    className="mx-6 mb-4 border flex flex-col justify-center shadow-re shadow-lg dark:border-gray-600 max-w-screen h-auto"
                  >
