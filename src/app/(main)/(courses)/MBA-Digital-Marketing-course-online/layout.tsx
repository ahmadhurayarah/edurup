...
function extractMetaFromFolder(currentFileUrl: string) {
  ...
  const description = `Join the best ${formattedCourse.toLowerCase()} course ${formattedCity}. Learn from industry experts and enhance your data skills with Edurup’s hands-on projects and placement guidance.`;
