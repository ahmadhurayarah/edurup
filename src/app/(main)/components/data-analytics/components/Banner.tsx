...
const CourseBanner = () => {
  ...
  return (
    <section className="relative mt-12">
      ...
      <div className="absolute inset-0 bg-[#6ed290] -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-16">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-16">
          ...
          {/* Left: Course Info */}
          <div className="flex-1 flex flex-col gap-4 sm:gap-6 text-black">
            <h1 className="text-3xl sm:text-5xl font-bold leading-snug">
              Best {courseTitle} in {cityTitle}.
            </h1>
            <p className="text-base sm:text-lg">
              32-week online {courseTitle} with Certification and 100% Placement
              Support in {cityTitle}.
            </p>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 mt-4">
              {[
                ...
                <div
                  key={idx}
                  className="flex flex-col items-start bg-white px-4 py-2 rounded-md w-full sm:w-auto"
                >
